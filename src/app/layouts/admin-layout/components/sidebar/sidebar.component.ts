...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    label: 'Oportunidades',
    route: '/oportunidades',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M3 12h18"/><path d="M10 12v2"/><path d="M14 12v2"/></svg>`
  },
  {
    label: 'Reportes',
    route: '/reportes',
    ...
    <aside class="sidebar" [class.sidebar--collapsed]="collapsed" aria-label="Navegación principal">
      <div class="sidebar__brand">
        <div class="sidebar__logo">
          ...
          <span *ngIf="!collapsed" class="sidebar__logo-text">GO MEDICAL</span>
        </div>
        <button
          ...
          <svg *ngIf="!collapsed" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div *ngIf="!collapsed" class="sidebar__nav-label">MENÚ</div>

      <nav class="sidebar__nav">
        <ul class="sidebar__nav-list">
          <li *ngFor="let item of navItems" class="sidebar__nav-item">
            <a
      ...
      <div class="sidebar__footer">
        ...
        <div *ngIf="!collapsed" class="sidebar__version">v1.0.0</div>
      </div>
    </aside>
  `,
