  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: 'Oportunidades',
        route: '/oportunidades',
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M3 12h18"/></svg>`
      },
    ]
  },
  {
  ...
  template: `
    <aside class="sidebar" [class.sidebar--collapsed]="collapsed" aria-label="Navegación principal">
      ...
      <div class="sidebar__brand">
        <div *ngIf="!collapsed" class="sidebar__logo">
          <div class="sidebar__logo-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M22 12h-4l-3 9L9 3l-3 9H2"/>
            </svg>
          </div>
          <div class="sidebar__logo-text-wrap">
            <span class="sidebar__logo-title">GO MEDICAL</span>
            <span class="sidebar__logo-sub">Web Administrativo</span>
          </div>
        </div>
        <button
          ...
          <svg *ngIf="!collapsed" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
          ...
          <ul class="sidebar__nav-list">
            <li *ngFor="let item of group.items" class="sidebar__nav-item">
              <a
                ...
                <span class="sidebar__nav-icon" [innerHTML]="item.safeIcon || item.icon"></span>
                <span *ngIf="!collapsed" class="sidebar__nav-text">{{ item.label }}</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="sidebar__footer">
        ...
        <div *ngIf="!collapsed" class="sidebar__version">Go Medical v1.0.0</div>
      </div>
    </aside>
  `,
...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    this.navGroups = NAV_GROUPS.map(group => ({
      ...group,
