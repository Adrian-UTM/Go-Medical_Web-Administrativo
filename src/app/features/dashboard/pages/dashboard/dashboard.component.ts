  ...
  readonly metrics = computed<MetricCardView[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        delta: safe.totalQuotes > 0 ? 'Seguimiento comercial disponible' : 'Sin cotizaciones registradas',
      ...
      },
      {
        ...
        delta: safe.openTickets > 0 ? 'Requieren seguimiento técnico' : 'Sin tickets abiertos',
      ...
      },
      {
        ...
        delta: safe.lowStockProducts > 0 ? 'Revisar reposición' : 'Sin alertas de inventario',
